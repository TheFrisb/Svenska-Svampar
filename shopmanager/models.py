...
class Register_Application(models.Model):
    ...
    business_typea = models.CharField(max_length=100, blank=True, verbose_name='Registrant Business Type')
    registration_notea = models.TextField(blank=True, verbose_name='Registrant Registration Note', null=True)
